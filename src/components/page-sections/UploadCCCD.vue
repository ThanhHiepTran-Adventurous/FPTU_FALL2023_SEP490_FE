...
const fileTempl = ref(undefined)
const imageTempl = ref(undefined)
const empty = ref(undefined)
const gallery = ref(undefined)
const overlay = ref(undefined)
const hidden = ref(undefined)

onMounted(() => {
    fileTempl.value = document.getElementById("file-template")
    imageTempl.value = document.getElementById("image-template")
    empty.value = document.getElementById("empty")
    gallery.value = document.getElementById("gallery")
    overlay.value = document.getElementById("overlay")

    hidden.value = document.getElementById("hidden-input");
