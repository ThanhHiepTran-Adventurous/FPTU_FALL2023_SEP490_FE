...
<template>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li><a href="listing-left-column.html">Trousers <span class="tt-badge tt-fatured">Fatured</span></a>
              </li>
          ...
          <li>
            ...
            <ul>
              ...
              <li><a href="listing-left-column.html">Sunglasses <span class="tt-badge tt-sale">Sale 15%</span></a>
              </li>
            </ul>
          </li>
          <li>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li><a href="listing-right-column.html">Trousers <span class="tt-badge tt-fatured">Fatured</span></a>
              </li>
          ...
          <li>
            ...
            <ul>
              ...
              <li><a href="listing-right-column.html">Sunglasses <span class="tt-badge tt-sale">Sale 15%</span></a>
              </li>
            </ul>
          </li>
        </ul>
  ...
  <div class="tt-mobile-header">
    <div class="container-fluid tt-top-line">
      <div class="tt-header-row flex !justify-between">
        <div class="tt-mobile-parent-menu-categories">
    ...
    <div class="container-fluid tt-top-line">
      <div class="row">
        <div class="tt-logo-container">
          <!-- mobile logo -->
          <a class="tt-logo tt-logo-alignment" href="index.html"><img src="/src/assets/img/custom/logo.png"
              alt=""></a>
          <!-- /mobile logo -->
        </div>
      </div>
    ...
    <div class="headerunderline tt-zindex-01">
      <div class="container">
        <div class="tt-header-holder tt-header-holder_main">
          ...
          <div class="tt-col-obj tt-obj-options header-inline-options-box">
            <!--========= visible only desktop ========= -->
            <!-- tt-wishlist -->
            <div class="tt-parent-box mr-5">
            ...
            <div class="tt-desctop-menu" id="tt-desctop-menu__icon">
              <nav aria-label="filter-bar">
                <ul>
                          ...
                          <div class="row tt-col-list">
                            ...
                            <div class="col-sm-3">
                              ...
                              <!-- <ul class="tt-listing-01">
                                ...
                                <li><a href="#" target="_blank"><img src="images/loader.svg"
                                      data-src="images/custom/brand-img-02.png" alt=""></a></li>
                                <li><a href="#" target="_blank"><img src="images/loader.svg"
                                      data-src="images/custom/brand-img-03.png" alt=""></a></li>
                                <li><a href="#" target="_blank"><img src="images/loader.svg"
                                      data-src="images/custom/brand-img-04.png" alt=""></a></li>
                                <li><a href="#" target="_blank"><img src="images/loader.svg"
                          ...
                          <div class="tt-menu-slider header-menu-product arrow-location-03 row">
                                ...
                                <a href="product.html">
                                  ...
                                  <div class="tt-description">
                                    ...
                                    <div class="tt-product-inside-hover">
                                      <div class="tt-btn-addtocart" data-toggle="modal"
                                        data-target="#modalAddToCartProduct">ADD TO CART</div>
                                      <div class="tt-btn-quickview" data-toggle="modal" data-target="#ModalquickView">
                                      </div>
                                    </div>
                                  </div>
                                </a>
                            ...
                            <div class="col-2">
                              <div class="tt-product thumbprod-center">
                                <a href="product.html">
                                  <div class="tt-image-box">
                                    <span class="tt-img"><img src="#" data-lazy="images/product/product-02.jpg"
                                        alt=""></span>
                                  </div>
                                  <div class="tt-description">
                                    <h2 class="tt-title">Flared Shift Dress</h2>
                            ...
                            <div class="col-2">
                              <div class="tt-product thumbprod-center">
                                <a href="product.html">
                                  <div class="tt-image-box">
                                    <span class="tt-img"><img src="#" data-lazy="images/product/product-05.jpg"
                                        alt=""></span>
                                  </div>
                                  <div class="tt-description">
                                    <h2 class="tt-title">Flared Shift Dress</h2>
                  ...
                  <li class="dropdown tt-megamenu-col-01 !text-center">
                    <a href="about.html">
                      <span class="tt-icon">
  ...
  <div class="tt-stuck-nav stuck-layout-02" id="js-tt-stuck-nav">
    <div class="container">
      <div class="tt-header-row flex">
        <div class="tt-logo-container pt-1">
          <!-- mobile logo -->
          <a class="tt-logo tt-logo-alignment" href="index.html"><img src="/src/assets/img/custom/logo.png"
              alt=""></a>
          <!-- /mobile logo -->
        </div>
        <div class="col-right !flex !items-center gap-6">
          <div class="tt-stuck-mobile-menu-categories">
            <button class="tt-categories-toggle mobile-toggle-icon-js">
              <i class="icon-categories"></i>
            </button>
          </div>
          <div class="tt-stuck-parent-cart"></div>
          <div class="tt-stuck-parent-account"></div>
        </div>
      </div>
    </div>
    <div class="container">
