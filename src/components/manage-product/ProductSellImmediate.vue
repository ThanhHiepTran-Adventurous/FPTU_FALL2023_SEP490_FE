...
import { immediateScriptBoughtPageSeller } from '@/common/commonStaticState'
...
const closeModalPayment = () => {
  router.push('/manage/auctioned/immediate').then(() => {
    location.reload()
  })
}
        ...
        <div class="pt-3 px-5 pb-1 flex items-center justify-between">
          <div class="font-bold text-2xl text-black text-blue-800 flex">
            ...
            <Tooltip class="relative ml-3" placement="rightBottom">
              <template #title>{{ immediateScriptBoughtPageSeller }}</template>
                ...
                <div class="text-red-500 text-lg">
                  ...
                  <span class="font-bold">{{
                    detail?.endDate
                      ? moment
                          .utc(detail?.endDate)
                          .add(systemStore.PaymentDeadline, 'days')
