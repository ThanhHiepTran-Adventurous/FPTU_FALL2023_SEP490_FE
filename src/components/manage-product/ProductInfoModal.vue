    ...
    <div class="bg-white rounded-lg space-y-4">
        ...
        <ul class="space-y-2 text-gray-700 pb-8 pt-4">
          <ul class="mt-2 text-gray-700">
            ...
            <li class="flex border-b py-2">
              ...
              <span class="text-gray-700"> <ProductStatusBadge :status="product?.status"></ProductStatusBadge> </span>
            </li>
            <li class="flex border-b py-2">
              <span class="font-bold w-50">Trọng lượng:</span>
              <span class="text-gray-700">{{ product?.weight + ' (gram) ' || 'N/A' }}</span>
            </li>
            <li class="flex border-b py-2">
              <span class="font-bold w-50">Thương hiệu:</span>
      ...
      <div :hidden="currentTab !== formTab">
        <form class="bg-white rounded px-8 pt-6 pb-8 mb-4">
          ...
          <AuctionConfirmModal
            v-if="isConfirmModalActive === true"
            :model-type="formData.modelType"
            @decline="isConfirmModalActive = false"
