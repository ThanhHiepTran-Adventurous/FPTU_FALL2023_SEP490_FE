    ...
    <div class="mb-4">
      <div class="text-black text-lg flex flex-col">
        <div>
            ...
            , bạn sẽ phải trả một khoản phí tương đương <span class="font-semibold text-red-500">{{ profit }}%</span> cho hệ thống. Với hình thức <span class="font-semibold text-blue-500">Tự trao đổi</span> sau <span class="font-semibold text-red-500">{{ days }}</span> ngày nếu bạn không thanh toán cho hệ thống, 
