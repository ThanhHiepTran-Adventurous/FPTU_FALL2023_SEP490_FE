            ...
            <div class="flex gap-2">
              <article
                ...
                <div v-if="feedbacks !== null && feedbacks.length > 0">
                  ...
                  <nav
                    v-if="feedbacks !== null && feedbacks.length > 3"
                ...
                <div v-if="feedbacks !== null && feedbacks.length > 0">
                  <div class="text-center">
                    ...
                    <div class="flex justify-center items-center">
                      <template v-for="index in Math.min(5, Math.floor(averageRating))">
                        <svg
                      ...
                      <template v-for="index in Math.max(0, 5 - Math.floor(averageRating))">
                        <svg
