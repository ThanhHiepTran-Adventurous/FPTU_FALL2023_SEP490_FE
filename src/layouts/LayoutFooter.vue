<template>
                ...
                <div class="row">
                        ...
                        <div class="tt-mobile-collapse">
                            ...
                            <div class="tt-collapse-content">
                                <ul class="tt-list">
                                    ...
                                    <li><a href="listing-collection.html">Voucher</a></li>
                                    <li><a href="listing-collection.html">Best seller</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="tt-mobile-collapse">
                            ...
                            <div class="tt-collapse-content">
                                <address>
                                    <p><span>Address:</span> 2548 Broaddus Maple Court Avenue, Madisonville KY 4783, United
                                        States of America</p>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="tt-newsletter">
                            <div class="tt-mobile-collapse">
                                ...
                                <div class="tt-collapse-content">
                                    <p>
                                        Sign up for our e-mail and be the first who know our special offers! Furthermore, we
                                        will give a 15% discount on the next order after you sign up.
                                    </p>
    ...
    <footer class="bg-blue-700 py-2 lg:py-4 mt-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row justify-between items-center">
            <div class="text-white text-sm lg:text-base">
                &copy; 2023 Bidbay. All right reserved
            </div>
            <nav class="">
